const messages = {
  'zh-CN': {
    ...
    'queue.help': '数字越小越先执行。闪电会将消息注入正在执行的回合；任务空闲时则立即启动。', 'queue.priority': '优先',
  ...
  en: {
    ...
    'queue.help': 'Lower numbers run first. Lightning injects the message into a running turn, or starts the task immediately when it is idle.', 'queue.priority': 'Priority',
