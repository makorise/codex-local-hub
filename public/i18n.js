const messages = {
  'zh-CN': {
    ...
    'usage.historyTitle': '最近 7 天', 'usage.historyDay': '{day} {percent}%', 'usage.historyMissing': '{day} 暂无本机记录',
    'usage.historyAria': '最近 7 天本机记录：{summary}', 'usage.historyNote': '按这台 Mac 观察到的周用量变化统计，仅保留最近 7 天。',
    ...
    'composer.startedHint': '消息已送达，任务正在启动', 'composer.queuedHint': '消息已保存，后台会按顺序处理', 'composer.delayed': '启动稍慢，消息仍安全保留在队列中', 'composer.failure': '发送失败，消息已放回输入框',
  ...
  en: {
    ...
    'usage.historyTitle': 'Last 7 days', 'usage.historyDay': '{day} {percent}%', 'usage.historyMissing': '{day} no local record',
    'usage.historyAria': 'Last 7 days observed locally: {summary}', 'usage.historyNote': 'Calculated from weekly-usage changes observed by this Mac; only the latest 7 days are kept.',
    ...
    'composer.startedHint': 'Message delivered. The task is starting.', 'composer.queuedHint': 'Message saved. It will run in order in the background.', 'composer.delayed': 'Startup is taking longer; your message is still safe in the queue.', 'composer.failure': 'Could not send. Your message was restored to the input.',
